...
Each chapter in the textbook will follow a consistent structure:

### Required Files per Chapter
- `index.mdx`: Main content with LaTeX math support
- `exercises.mdx`: Chapter problems and projects
...
The textbook will be built using Docusaurus with the following configuration:
...
## 3. TEXTBOOK OUTLINE: Physical AI & Humanoid Robotics
...
- Web-based ROS2 visualization using rosbridge
- Interactive 3D models with Three.js
- Jupyter notebook integration for live coding
- Simulation demos that run in browser
